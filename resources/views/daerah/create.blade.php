            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('daerah.store') }}" method="post">
                        @csrf
                        <!-- <div class="mb-3"><label for="namadaerahlabel">Nama Daerah</label><input class="form-control form-control-solid" id="nama_daerah" name="nama_daerah" type="text" placeholder="Contoh: Bandung"></div> -->
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-12" id="rates">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="nama_daerah" value="Bandung">Bandung
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="nama_daerah" value="Jakarta">Jakarta
                                </div>
                                <!--  -->
                                </div>
                        </div>
                        ...
                        <input class="form-control form-control-solid" id="jumlah_penginapan" name="jumlah_penginapan" type="text" placeholder="Contoh: 1" value="{{old('jumlah_penginapan')}}">
                        </div>
                        
          
                        <div class="mb-0"><label for="jumlahkendaraanlabel">Jumlah Kendaraan</label>
                            <input class="form-control form-control-solid" id="jumlah_kendaraan" name="jumlah_kendaraan"  placeholder="Cth: 1">{{old('jumlah_kendaraan')}}
                        </div>

                        <div class="mb-0"><label for="destinasifavoritlabel">Destinasi Favorit</label>
                            <input class="form-control form-control-solid" id="destinasi_favorit" name="destinasi_favorit"  placeholder="Cth: Lembang">{{old('destinasi_favorit')}}
                        </div>

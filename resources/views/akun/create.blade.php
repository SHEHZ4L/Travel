            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('akun.store') }}" method="post">
                        @csrf
                        <div class="mb-3"><label for="kodeakunlabel">Kode Akun</label><input class="form-control form-control-solid" id="kode_akun" name="kode_akun" type="text" placeholder="Contoh: 111"></div>
                        ...
                        <div class="mb-0"><label for="headerakunlabel">Header Akun</label>
                            <input class="form-control form-control-solid" id="header_akun" name="header_akun" type="text"  placeholder="Cth: 1">{{old('header_akun')}}
                        </div>
                        <br>
                        <!-- untuk tombol simpan -->

            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('akun.update', $akun->id) }}" method="post">
                        @csrf
                        @method('PUT')
                            <div class="mb-3"><label for="kodeakunlabel">Kode Akun</label><input class="form-control form-control-solid" id="kode_akun" name="kode_akun" type="text" placeholder="Contoh: PR-001" value="{{$akun->kode_akun}}" readonly></div>
                            
                            <div class="mb-3"><label for="namaakunlabel">Nama Akun</label>
                            <input class="form-control form-control-solid" id="nama_akun" name="nama_akun" type="text" placeholder="Contoh: Toko Mukena Sejuk Menenangkan" value="{{$akun->nama_akun}}">
                            </div>
                            
            
                            <div class="mb-0"><label for="alamatakunlabel">Header Akun</label>
                                <input class="form-control form-control-solid" id="header_akun" name="header_akun" type="text" placeholder="Cth: Jl Pelajar Pejuan 45" value="{{$akun->header_akun}}">
                            </div>
                            <br>
                            <!-- untuk tombol simpan -->

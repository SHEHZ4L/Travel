            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('mitra.update', $mitra->id) }}" method="post">
                        @csrf
                        @method('PUT')
                            <div class="mb-3"><label for="kodemitralabel">Nama Mitra</label><input class="form-control form-control-solid" id="nama_mitra" name="nama_mitra" type="text" placeholder="Contoh: PR-001" value="{{$mitra->nama_mitra}}"></div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-12" id="rates">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="jenis_mitra" value="Penginapan" {{ $mitra->jenis_mitra == 'Penginapan' ? 'checked' : '' }}>
                                        Penginapan
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="jenis_mitra" value="Kendaraan" {{ $mitra->jenis_mitra == 'Kendaraan' ? 'checked' : '' }}>
                                        Kendaraan
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="jenis_mitra" value="Tempat_Wisata" {{ $mitra->jenis_mitra == 'Tempat_Wisata' ? 'checked' : '' }}>
                                        Tempat Wisata
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-0"><label for="alamatmitralabel">Alamat Mitra</label>
                                <input class="form-control form-control-solid" id="alamat_mitra" name="alamat_mitra" type="text" placeholder="Cth: Jl Pelajar Pejuan 45" value="{{$mitra->alamat_mitra}}">
                            </div>
                            <br>
                            <!-- untuk tombol simpan -->
